...
class transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.toy_samp_rate = toy_samp_rate = 2000
        self.samp_rate = samp_rate = 2e6
        self.freq = freq = 40.68e6
        ...
        self.connect((self.toyTank_spoofer_0, 0), (self.blocks_float_to_complex_0, 0))
    ...
    def get_toy_samp_rate(self):
        return self.toy_samp_rate

    def set_toy_samp_rate(self, toy_samp_rate):
        self.toy_samp_rate = toy_samp_rate
