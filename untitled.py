...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'gnuradio-40MHz-2MHz.cfile', False)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_correctiq_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_correctiq_0, 0), (self.qtgui_sink_x_0_0, 0))
